...
def get_options(option_type):
  ...
  tf.app.flags.DEFINE_string("checkpoint_dir", "/UNREAL/unreal_checkpoints", "chFeckpoint directory")
  ...
  if option_type == 'training':
    ...
    tf.app.flags.DEFINE_string("log_file", "/UNREAL/unreal_log/unreal_log", "log file directory")
  ...
  if option_type == 'display':
    tf.app.flags.DEFINE_string("frame_save_dir", "/UNREAL/unreal_frames", "frame save directory")
